...
t1 = new ASTBool(Boolean.parseBoolean(n.image));
    ...
    case MINUS:{
      ...
      t1 = Fact();
IValue tmp = t1.eval(new Env()); if(tmp instanceof VInt){
          t1 = new ASTNum(-((VInt)tmp).getval());
        }else{{if (true) throw new TypeError("- unary operator undefined for that");}}
      break;
      }
    case NOT:{
      jj_consume_token(NOT);
      t1 = Fact();
IValue tmp = t1.eval(new Env()); if(tmp instanceof VBool){
...
{if ("" != null) return t1;}
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1804000,0x1804000,0x6002000,0x6002000,0x9f18000,};
   }
